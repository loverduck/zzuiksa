...
class GifticonList extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  buildGridView(gifticons.where((i) => i.isUsed == '미사용' || i.isUsed == '사용중').cast<Map<String, dynamic>>().toList(), 2),
                  buildGridView(gifticons.where((i) => i.isUsed == '사용완료').cast<Map<String, dynamic>>().toList(), 2),
                ],
              ),
            ),
          ],
  ...
  Widget buildGridView(List<Map<String, dynamic>> gifticons, int crossAxisCount) {
